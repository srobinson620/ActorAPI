...
Most of the tests written here will be happy path tests, in the real world we should also write tests to tests
both the extreems of the happy path (smallest supported inmput largest supported inmput etc)  and all failing options.
